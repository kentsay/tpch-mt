...
import static ch.ethz.system.mt.tpch.GeneratorAssertions.assertEntityLinesMD5;
...
public class TestLineItemGenerator
{
    ...
    {
        assertEntityLinesMD5(new LineItemGenerator(scaleFactor, step, children, new int[] {1}), expectedMD5);
    }
}
